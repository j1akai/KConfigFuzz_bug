...
void execute_one(void)
{
  ...
  //        ifr_ifrn: buffer: {73 69 74 30 00 00 00 00 00 00 00 00 00 00 00 00}
  //        (length 0x10) elem: ifru_flags = 0x200 (2 bytes) pad = 0x0 (22
  //        bytes)
  //      }
  //    }
  //  ]
  ...
  *(uint16_t*)0x200000000010 = 0x200;
  ...
  //          02} (length 0x10)
  //        }
  //        rtmsg_type: int32 = 0x2 (4 bytes)
  //        rtmsg_dst_len: int16 = 0x8 (2 bytes)
  //        rtmsg_src_len: int16 = 0x9 (2 bytes)
  //        rtmsg_metric: rtmsg_metrics = 0x500 (4 bytes)
  //        pad = 0x0 (4 bytes)
  //        rtmsg_info: intptr = 0x1 (8 bytes)
  //        rtmsg_flags: rtmsg_flags = 0x880200 (4 bytes)
  //        rtmsg_ifindex: ifindex (resource)
  //      }
  //    }
  //  ]
  memset((void*)0x200000000500, 0, 10);
  memset((void*)0x20000000050a, 255, 2);
  *(uint32_t*)0x20000000050c = htobe32(0x7f000001);
  *(uint8_t*)0x200000000510 = -1;
  *(uint8_t*)0x200000000511 = 1;
  memset((void*)0x200000000512, 0, 13);
  *(uint8_t*)0x20000000051f = 1;
  memcpy((void*)0x200000000520,
         " \001\000\000\000\000\000\000\000\000\000\000\000\000\000\002", 16);
  *(uint32_t*)0x200000000530 = 2;
  *(uint16_t*)0x200000000534 = 8;
  *(uint16_t*)0x200000000536 = 9;
  *(uint32_t*)0x200000000538 = 0x500;
  *(uint64_t*)0x200000000540 = 1;
  *(uint32_t*)0x200000000548 = 0x880200;
  *(uint32_t*)0x20000000054c = 0;
  inject_fault(8);
  syscall(__NR_ioctl, /*fd=*/r[1], /*cmd=*/0x890b, /*arg=*/0x200000000500ul);
}
int main(void)
{
