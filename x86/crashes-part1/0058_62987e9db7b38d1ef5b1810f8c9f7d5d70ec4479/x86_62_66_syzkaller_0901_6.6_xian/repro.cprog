...
void execute_one(void)
{
  ...
  *(uint64_t*)0x200000000100 = 0x200000000680;
  *(uint32_t*)0x200000000680 = 0x30;
  *(uint16_t*)0x200000000684 = r[1];
  *(uint16_t*)0x200000000686 = 5;
  *(uint32_t*)0x200000000688 = 0x200000;
  *(uint32_t*)0x20000000068c = 0;
  *(uint8_t*)0x200000000690 = 6;
  *(uint8_t*)0x200000000691 = 0;
  *(uint16_t*)0x200000000692 = 0;
  *(uint16_t*)0x200000000694 = 8;
  *(uint16_t*)0x200000000696 = 3;
  *(uint32_t*)0x200000000698 = r[2];
  *(uint16_t*)0x20000000069c = 8;
  *(uint16_t*)0x20000000069e = 5;
  *(uint32_t*)0x2000000006a0 = 7;
  *(uint16_t*)0x2000000006a4 = 0xa;
  *(uint16_t*)0x2000000006a6 = 0x18;
  memset((void*)0x2000000006a8, 3, 6);
  *(uint64_t*)0x200000000108 = 0x30;
