...
void execute_one(void)
{
  ...
  //  openat$6lowpan_control arguments: [
  //    fd: const = 0xffffffffffffff9c (8 bytes)
  //    file: ptr[in, buffer] {
  //      buffer: {2f 73 79 73 2f 6b 65 72 6e 65 6c 2f 64 65 62 75 67 2f 62 6c
  //      75 65 74 6f 6f 74 68 2f 36 6c 6f 77 70 61 6e 5f 63 6f 6e 74 72 6f 6c
  //      00} (length 0x2c)
  //    }
  //    flags: const = 0x2 (4 bytes)
  //    mode: const = 0x0 (2 bytes)
  //  ]
  //  returns fd_6lowpan_control
  ...
  if (res != -1)
    r[0] = res;
  //  write$6lowpan_control arguments: [
  //    fd: fd_6lowpan_control (resource)
  //    data: ptr[in, buffer] {
  //      buffer: {63 6f 6e 6e 65 63 74 20 61 61 3a 61 61 3a 61 61 3a 61 61 3a
  //      61 61 3a 31 31 20 30} (length 0x1b)
  //    }
  //    len: bytesize = 0x1b (8 bytes)
  //  ]
  memcpy((void*)0x200000000080, "connect aa:aa:aa:aa:aa:11 0", 27);
  syscall(__NR_write, /*fd=*/r[0], /*data=*/0x200000000080ul, /*len=*/0x1bul);
  ...
  if (res != -1)
    r[1] = res;
  //  connect$bt_sco arguments: [
  //    fd: sock_bt_sco (resource)
  //    addr: ptr[in, sockaddr_sco] {
  //      sockaddr_sco {
  //        fam: const = 0x1f (2 bytes)
  //        addr: union bdaddr_t {
  //          fixed: bdaddr_fixed {
  ...
  //      }
  //    }
  //    addrlen: len = 0x8 (8 bytes)
  //  ]
  *(uint16_t*)0x200000004740 = 0x1f;
  memset((void*)0x200000004742, 170, 5);
  *(uint8_t*)0x200000004747 = 0x11;
  syscall(__NR_connect, /*fd=*/r[1], /*addr=*/0x200000004740ul,
          /*addrlen=*/8ul);
}
int main(void)
{
